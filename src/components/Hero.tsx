    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      >
        <motion.div
          ...
          className="absolute inset-0 w-full h-full bg-gradient-to-br from-[#0a0a0a] via-[#9d4edd] to-[#00d4ff] opacity-40 blur-2xl bg-[length:200%_200%]"
          style={{ zIndex: 1 }}
        />
        <motion.div
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
        <motion.div
          className="h-24 mb-6 flex items-center justify-center"
